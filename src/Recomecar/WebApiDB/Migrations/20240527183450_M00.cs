...
namespace WebApiDB.Migrations
{
    ...
    public partial class M00 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "UsuarioId", "Email", "Image", "Nome", "Password", "TipoUsuario" },
                values: new object[,]
                {
                    { 1, "janinhabbs@hotmail", ".", "Janaina Leal", "123456*", 1 },
                    { 2, "iancorrea@hotmail", ".", "Ian Merlo Corrêa", "123456*", 1 },
                    { 3, "leandroreis@hotmail", ".", "Leandro Henrique de Oliveira Reis", "123456*", 1 },
                    { 4, "marcosmaciel@hotmail", ".", "Marcos Paulo Assiz Maciel", "123456*", 1 },
                    { 5, "ricardojunior@hotmail", ".", "Ricardo Moreira Siqueira Junior", "123456*", 1 },
                    { 6, "silbarbosa@hotmail", ".", "Silmara Eugênia Barbosa", "123456*", 1 }
                });
