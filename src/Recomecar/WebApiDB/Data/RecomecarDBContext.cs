    ...
    public class RecomecarDBContext(DbContextOptions<RecomecarDBContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Categoria>().HasData(
                new Categoria() { CategoriaID = 1, CategoriaNome = "Cadeira de Rodas" },
                new Categoria() { CategoriaID = 2, CategoriaNome = "Andarilho" },
                new Categoria() { CategoriaID = 3, CategoriaNome = "Cama Articulada" }
                );
